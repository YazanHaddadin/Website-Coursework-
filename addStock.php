...
addStock($conn, $game, $game_type, $age_group, $quantity);

function addStock($conn, $game, $game_type, $age_group, $quantity)
{
if($game != "" && $game_type != "--" && $age_group != "--" && $quantity != ""){
  $sql = "INSERT INTO stocks (id, game, type, age_group, quantity) VALUES (NULL, '$game', '$game_type', '$age_group', '$quantity');";

  if ($conn->query($sql) === TRUE)
{
    echo "<p id=Success> Successfully added Record </p> <br /><br />";
